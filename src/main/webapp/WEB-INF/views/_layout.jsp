...
<%
    ...
    debugMessages.add("Page loaded: " + contentPage);
    debugMessages.add("Status: " + statusCodeMessage);

    // Добавляем дополнительную отладочную информацию, если она есть
    Object debugInfo = request.getAttribute("debugInfo");
    if (debugInfo != null) {
        debugMessages.add(debugInfo.toString());
    }

    // Преобразуем список сообщений в JSON
    String debugMessagesJson = new Gson().toJson(debugMessages);
...
<div class="container-fluid vh-100">
    <div class="row h-100">
        <div class="col-md-9 h-100 overflow-auto" id="main-content">
            <header>
                <nav class="navbar navbar-expand-lg bg-body-tertiary">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">
                            <img src="<%=contextPath%>/img/images.webp" alt="logo"
        ...
        <div class="col-md-3 h-100 d-flex flex-column" id="debug-terminal-container">
            <h5>Debug Terminal</h5>
            <button id="update-debug-info" class="btn btn-primary mb-2">Update Debug Info</button>
            <div id="debug-terminal" class="flex-grow-1 overflow-auto">
...
<script>
    let debugMessagesJson = <%= debugMessagesJson %>;
...
<script>
    ...
    addToTerminal('Page loaded');
    addToTerminal('Status: <%= statusCodeMessage %>');
